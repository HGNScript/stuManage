    ...
    layui.use('laydate', function () {
        ...
        laydate.render({
            elem: '#stu_bytime',
                ...
                if (!value) {
                    $('#stu_bytime').css({"borderColor": "#FF0000"})
                } else {
                    $('#stu_bytime').css({"borderColor": "#5FB878"})
                }
            }
        })
    ...
    layui.use('form', function () {
        ...
        form.on('radio(stu_retiredsoldier)', function (data) {
            ...
            if (data.value == '否') {
                ...
                $('#stu_originalmilitaryrank').attr({disabled: 'disabled'})
                $('#stu_demobilizedstyle').attr({disabled: 'disabled'})
                form.render('select')
                ...
                $('#stu_demobilizedstyle').removeAttr("disabled")
                form.render('select')
    ...
    function stuInfoSubmit() {
        ...
        $('#stuInfoSubmit').click(function () {
            ...
            if (stu_infoflag != 1) {
                ...
                layer.confirm('请确认你的姓名，身份证等关键信息是否正确，如果发现错误，请联系班主任', function (index) {
                    var info = $("#stuInfoForm").serialize();
